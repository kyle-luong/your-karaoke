...
import { Clock, Play, Music, Sparkles } from "lucide-react";
...
export default function SongHero({ song, originalLyrics }: SongHeroProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-8 items-start">
      ...
      <div className="flex flex-col gap-3">
        ...
        {/* Title */}
        <h1 className="text-4xl font-black tracking-tight">{song.title}</h1>
        ...
        <div className="flex flex-wrap items-center gap-3 mt-2">
          <Link
            ...
            className="inline-flex items-center gap-2 px-8 py-3 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-sm transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 w-fit"
          >
          ...
          {originalLyrics && (
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-primary text-primary-foreground font-bold text-sm uppercase tracking-wide hover:bg-primary/90 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5"
            >
